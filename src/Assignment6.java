...
/*
 * 6.	Write a class named Assignment6 which creates a float variable x. 
 * Set x to some value. Then write an if-statement that checks if x is equal to 3. 
 * If so, print the message, “x is equal to 3”. Write an else-if statement to check if x is greater than 5, 
 * and, if so, prints the message, “x is greater than 5”. 
 * 
